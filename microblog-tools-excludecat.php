<?php
/*
Plugin Name: Micro-blog Tools - Exclude Category 
Plugin URI: http://github.com/chimo/microblog-tools
Description: Exclude posts in certain categories from being published on your micro-blog by Micro-blog Tools. This plugin relies on Micro-blog Tools, configure it on the Micro-blog Tools settings page.
Version: 0.1
Author: @chimo
